...
exports.archiveChannel = void 0;
const core = __nccwpck_require__(186);
const httpClient = __nccwpck_require__(255);
function archiveChannel(appSlug, channelId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const archiveChannelUri = `${replicatedEndpoint}/app/${appId}/channel/${channelId}`;
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield (0, channels_1.archiveChannel)(core.getInput('replicated-app'), core.getInput('channel-id'));
        }
        catch (error) {
