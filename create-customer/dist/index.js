...
function findApplicationDetailsInOutput(apps, appSlug) {
    return __awaiter(this, void 0, void 0, function* () {
...
function createCustomer(appSlug, name, email, licenseType, channelName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const createCustomerRes = yield http.post(createCustomerUri, JSON.stringify(createCustomerReqBody));
            ...
            const downloadLicenseBody = JSON.parse(yield downloadLicenseRes.readBody());
