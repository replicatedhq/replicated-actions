...
export async function actionCreateCluster() {
  try {
    ...
    let cluster = await createClusterWithLicense(apiClient, name, k8sDistribution, k8sVersion, licenseId, k8sTTL, diskGib, nodeCount, minNodeCount, maxNodeCount, instanceType, nodeGroupsArray, tagsArray, ipFamily);
